...
const initalState = {firstname: '', lastname: '', email: '', year: '', fromLargeFamily: false, isDisabled: false, fromIncompleteFamily: false, isOrphan: false, docs: []};
const errorsInitial = {firstname:'',lastname:'', year:'', email: '', docs: ''};
